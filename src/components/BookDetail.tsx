...
export default function BookDetail(
  ...
  return (
    <div class="flex p-4 bg-gray-800 text-white transition hover:bg-gray-700 border border-gray-600 shadow-md transform">
      <div class="w-3/4">
        <iframe
          src={`${apiroot}/lit/${book().id}`}
          title="Score PDF"
          class="w-full h-full min-h-[400px] border-2 border-gray-600 rounded-md"
        />
      </div>
      <div class="w-3/4 pl-4">
        <div class="flex flex-col justify-between h-full">
          <div>
            ...
            <p class="text-gray-300 mb-1">Year: {book().year}</p>
            <p class="text-gray-300">Genre: {book().genre}</p>
          </div>
          <div>
            <p class="text-gray-400 mt-4">{book().description}</p>
          </div>
